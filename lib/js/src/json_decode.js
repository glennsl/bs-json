...
function at(topKey, key_path, decoder) {
  var _l = List.rev(key_path);
  var _decoder = decoder;
  var prev = topKey;
  while(true) {
    var decoder$1 = _decoder;
    var l = _l;
    if (l) {
      var x = l[0];
      _decoder = (function(decoder$1,x){
      return function (param) {
        return field(x, decoder$1, param);
      }
      }(decoder$1,x));
      _l = l[1];
      continue ;
      ...
      return (function(decoder$1){
      return function (param) {
        return field(prev, decoder$1, param);
      }
      }(decoder$1));
    }
  };

...
describe("tuple2", (function () {
        Jest.test("heterogenous", (function () {
                return Jest.Expect[/* toEqual */12](/* tuple */[
                              "a",
                              3
                            ])(Jest.Expect[/* expect */0](Json_decode.tuple2(Json_decode.string, Json_decode.$$int, JSON.parse(" [\"a\", 3] "))));
              }));
        Jest.test("too small", (function () {
                return Jest.Expect[/* toThrow */18](Jest.Expect[/* expectFn */1]((function (param) {
...
describe("tuple3", (function () {
        Jest.test("heterogenous", (function () {
                return Jest.Expect[/* toEqual */12](/* tuple */[
                              ...
                              3,
                              4.5
                            ])(Jest.Expect[/* expect */0](Json_decode.tuple3(Json_decode.string, Json_decode.$$int, Json_decode.$$float, JSON.parse(" [\"a\", 3, 4.5] "))));
              }));
        Jest.test("too small", (function () {
                return Jest.Expect[/* toThrow */18](Jest.Expect[/* expectFn */1]((function (param) {
...
describe("tuple4", (function () {
        Jest.test("heterogenous", (function () {
                return Jest.Expect[/* toEqual */12](/* tuple */[
                              ...
                              4.5,
                              /* true */1
                            ])(Jest.Expect[/* expect */0](Json_decode.tuple4(Json_decode.string, Json_decode.$$int, Json_decode.$$float, Json_decode.bool, JSON.parse(" [\"a\", 3, 4.5, true] "))));
              }));
        Jest.test("too small", (function () {
                return Jest.Expect[/* toThrow */18](Jest.Expect[/* expectFn */1]((function (param) {

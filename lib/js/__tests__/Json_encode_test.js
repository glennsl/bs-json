...
Jest.test("optional (None)", (function () {
        return Jest.Expect[/* toEqual */12](undefined)(Jest.Expect[/* expect */0](Json_encode.optional((function (prim) {
                              return prim;
                            }), /* None */0)));
      }));

Jest.test("optional (Some)", (function () {
        return Jest.Expect[/* toEqual */12]("success")(Jest.Expect[/* expect */0](Json_encode.optional((function (prim) {
                              return prim;
                            }), /* Some */["success"])));
      }));

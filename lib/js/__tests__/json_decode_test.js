  ...
  switch (param) {
    ...
    case 5 : 
        return Jest.test(prefix + "object", (function () {
                      return Curry._1(Jest.Expect[/* toThrow */18], Curry._2(Jest.Expect[/* expectFn */1], decoder, Json_encode.object_(/* [] */0)));
                    }));
    case 6 : 
...
describe("dict", (function () {
        Jest.test("object", (function () {
                return Curry._2(Jest.Expect[/* toEqual */12], { }, Curry._1(Jest.Expect[/* expect */0], Json_decode.dict(Json_decode.$$int, Json_encode.object_(/* [] */0))));
              }));
...
describe("optional", (function () {
        ...
        Jest.test("object -> int", (function () {
                return Curry._2(Jest.Expect[/* toEqual */12], /* None */0, Curry._1(Jest.Expect[/* expect */0], Json_decode.optional(Json_decode.$$int, Json_encode.object_(/* [] */0))));
              }));
        Jest.test("boolean -> boolean ", (function () {
...
describe("withDefault", (function () {
        ...
        return Jest.test("object", (function () {
                      return Curry._2(Jest.Expect[/* toEqual */12], 0, Curry._1(Jest.Expect[/* expect */0], Json_decode.withDefault(0, Json_decode.$$int, Json_encode.object_(/* [] */0))));
                    }));
      }));

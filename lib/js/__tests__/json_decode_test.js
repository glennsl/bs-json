...
function test(decoder, param) {
  switch (param) {
    case 0 : 
        return Jest.test("float", function () {
                    return Curry._1(Jest.Expect[/* toThrow */18], Curry._2(Jest.Expect[/* expectFn */1], decoder, 1.23));
                  });
    case 1 : 
        return Jest.test("int", function () {
    ...
    case 3 : 
        return Jest.test("null", function () {
    ...
    case 6 : 
        return Jest.test("boolean", function () {
...
function throws(decoder, _param) {
  while(true) {
    var param = _param;
    if (param) {
      test(decoder, param[0]);
      _param = param[1];
      continue ;
...
describe("boolean", function () {
      ...
      return throws(Json_decode.$$boolean, /* :: */[
                  /* Float */0,
                  /* :: */[
                    /* Int */1,
                    /* :: */[
...
describe("bool", function () {
      ...
      return throws(Json_decode.bool, /* :: */[
                  /* Float */0,
                  /* :: */[
                    /* Int */1,
                    /* :: */[
...
describe("float", function () {
      ...
      return throws(Json_decode.$$float, /* :: */[
                  /* Bool */6,
                  /* :: */[
                    /* String */2,
                    /* :: */[
...
describe("string", function () {
      ...
      return throws(Json_decode.string, /* :: */[
                  /* Bool */6,
                  /* :: */[
                    /* Float */0,
                    /* :: */[
...
describe("nullable", function () {
      ...
      return Jest.test("null -> null", function () {
...
describe("list", function () {
      ...
      return Jest.test("array int -> list boolean", function () {
                  return Curry._1(Jest.Expect[/* toThrow */18], Curry._2(Jest.Expect[/* expectFn */1], function (param) {
...
describe("at", function () {
      ...
      Jest.test("at boolean", function () {
            return Curry._2(Jest.Expect[/* toEqual */12], false, Curry._1(Jest.Expect[/* expect */0], Curry._1(Json_decode.at("a", /* :: */[
                                    "x",
                                    /* :: */[
                                      "y",
                                      /* [] */0
                                    ]
                                  ], Json_decode.$$boolean), JSON.parse(" { \"a\": { \"x\" : { \"y\" : false } }, \"b\": false } "))));
          });
      return Jest.test("field nullAs", function () {
                  var partial_arg = null;
                  return Curry._2(Jest.Expect[/* toEqual */12], null, Curry._1(Jest.Expect[/* expect */0], Curry._1(Json_decode.at("a", /* :: */[
                                          "x",
                                          /* [] */0
                                        ], function (param) {
                                          return Json_decode.nullAs(partial_arg, param);
                                        }), JSON.parse(" { \"a\": { \"x\" : null }, \"b\": null } "))));
                });
    });
...
describe("oneOf", function () {
      ...
      return Jest.test("object with field", function () {
...
describe("either", function () {
      throws(Json_decode.either(Json_decode.$$int, function (param) {
                return Json_decode.field("x", Json_decode.$$int, param);
              }), /* :: */[
            /* Bool */6,
            /* :: */[
...
describe("andThen", function () {
      ...
      return Jest.test("int -> float andThen int", function () {
                  return Curry._2(Jest.Expect[/* toEqual */12], 23, Curry._1(Jest.Expect[/* expect */0], Json_decode.andThen(function () {
                                      return Json_decode.$$int;
